  ...
  return (
    <div className="home-page">
      ...
      <div className="controls">
        <input type="text" placeholder="loan amount" id="loan-amount" onChange={loanAmountHandler}/>
        <button className="get-rates" onClick={getRates}>get latest rates</button>
